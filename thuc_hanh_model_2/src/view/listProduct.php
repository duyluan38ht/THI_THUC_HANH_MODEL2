    ...
    <?php foreach ($products as $key => $product): ?>
        <tr>
            ...
            <td style="text-align: center">
                <a style="width: 120px" class="btn btn-info" href="index.php?page=update&id=<?php echo $product->getId(); ?>">Chỉnh sửa</a>
                <a style="width: 120px" class="btn btn-danger" onclick="return confirm('Bạn chắc chứ?')"
